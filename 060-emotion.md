...
Their first step was to compile a long
list of 28 feelings that might be evoked by music, based
...
extracts conveying each of these feelings. The outcome was a library
of 1,841 extracts.
...
dimensions compiled from existing theories of emotion:
...
It is interesting to see that the two fundamental emotion dimensions
arousal and valence achieve relatively low correlations across cultures,
and are outperformed by many individual emotion categories.
@Cowen2020-jx argue that this contradicts a key claim of dimensional theories
of emotion, namely that experienced emotions come from combinations of 
'essential' dimensions like arousal and valence.
However, there are other possible explanations too.
For example, these more essential concepts (e.g. arousal, valence) might be 
harder for listeners to access consciously than more concrete concepts like
'triumph'. They might also simply be harder to translate accurately between
English and Chinese.
...
but still many more than the two or three dimensions ordinarily used 
in dimensional models of emotion such as the circumplex model.
That said, if we look at their Figure 2, we can see that only the first
...
![**Correlations for extracted dimension between US and Chinese listeners, from @Cowen2020-jx.** Asterisks indicate statistically significant correlations.](images/cowen-2000/cowen-2000-fig-2.png){width='35%'}
