...
") %>% DiagrammeRsvg::export_svg () %>% charToRaw -> gems_svg

# LaTeX cannot include SVGs without Inkscape, so we render a PDF for it instead.
gems_file <- if (knitr::is_html_output()) {
  rsvg::rsvg_svg(gems_svg, "images/GEMS.svg")
  "images/GEMS.svg"
} else {
  rsvg::rsvg_pdf(gems_svg, "images/GEMS.pdf")
  "images/GEMS.pdf"
}

knitr::include_graphics(gems_file)
```
