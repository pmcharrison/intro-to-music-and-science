...
embed_image_with_audio(
  image = "images/consonance-perfect-fifth.png", 
  audio = "audio/perfect-fifth.wav", 
  width = "100%", 
  title = "The harmonicity and periodicity of the perfect fifth."
)
```
...
```{r}
embed_image_with_audio(
  image = "images/consonance-tritone.png", 
  audio = "audio/tritone.wav", 
  width = "100%", 
  title = "The low harmonicity and limited periodicity of the tritone."
)
```
...
```{r}
embed_image_with_audio(
  image = "images/consonance-beating.png", 
  audio = "audio/beating-400-430.wav", 
  width = "100%",
  title = "Beating resulting from combining pure tones of 400 Hz and 430 Hz."
)
```
...
embed_video(
  # also hosted at https://s3-eu-west-1.amazonaws.com/media.pmcharrison.com/music/cross-cultural-consonance/GangaLive.mp4
  "images/GangaLive.mp4",
  title = "A performance by a group of Bosnian Ganga singers. Credit: Pantelis N. Vassilakis, http://acousticslab.org/RECA220/",
  width = "100%"
)
```
