...
Four kinds of plots are common for plotting distributions of continuous variables: *histograms*, *kernel density plots*, and *dot plots*.
...
Boxplots are more common in older papers.
