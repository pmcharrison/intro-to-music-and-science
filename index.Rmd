...
description: |
  This is a collection of draft lecture notes for Introduction to Music and Science teaching 
...
R.utils::copyDirectory(
  "packages/chrome-music-lab/spectrogram/build", 
  "_book/spectrogram",
  overwrite = TRUE
)
```
