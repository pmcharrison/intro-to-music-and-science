...
It is generally assumed that the dissonance induced by a pair of partials comes from resulting beating effects (though see @Harrison2020-gx for a discussion of this assumption). The magnitude of this beating effect is modelled using the dissonance curve plotted in 

Several limitations of this model have been noted over recent decades.
