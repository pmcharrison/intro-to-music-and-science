...
Let's compute the mean of our dataset of distances, and plot it on our histogram.
...
In this example the median is significantly smaller than the median. This is commonly the case with *skewed* distribution. Skewed distributions can often be found in socioeconomic studies; for example, income distributions tend to have the majority of incomes bunched towards the bottom of the distribution, contrasting with a smaller number of much higher incomes towards the top of the distribution. This yields the paradoxical situation that the 'average' person earns less than the average income.
...
Visualisations are great, but often we must describe data in terms of concrete numbers. In particular, *descriptive statistics* usefully summarise
