...
embed_image(
  ...
  info = "**A:** Helmholtz's *sympathetic resonance* theory [@Helmholtz1875-fm]. **B:** von Békésy's travelling wave theory [@Von_Bekesy1960-oh].",
  width = "100%",
...
The tonotopic nature of the basilar membrane is often described using the
