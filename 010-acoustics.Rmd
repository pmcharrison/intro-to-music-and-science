...
embed_image_with_audio(
  ...
  width = "500",
  caption = "A sine wave with an amplitude of 0.5 - test."
)
```

![**A sine wave with an amplitude of 0.5.** (ref:test-audio)](images/sine-wave-amplitude=0.5.png){width="500"}

```{r}
embed_audio("audio/tone-waveform.wav", ref = "(ref:test-audio)")
```
