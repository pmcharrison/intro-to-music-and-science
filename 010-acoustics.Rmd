...
A square wave is produced like a sawtooth wave, but with one simple change: all the even harmonics are removed. The resulting wave sounds a bit less brassy and more like a clarinet.
...
embed_image_with_audio(
  ...
  credit = "megatron, [CC BY-SA 3.0](https://creativecommons.org/licenses/by-sa/3.0/deed.en), via Wikimedia Commons."
)
```
...
<iframe width="560" height="315" src="https://www.youtube.com/embed/vvr9AMWEU-c" title="Spectrogram for dialup modem" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
