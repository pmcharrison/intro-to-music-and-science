...
![**A sine wave with an amplitude of 0.5.** (ref:a1c2ccb6-d5f8-4a11-9f06-f8f507971ec6) ](images/sine-wave-amplitude=0.5.png){width='500'}

(ref:a1c2ccb6-d5f8-4a11-9f06-f8f507971ec6)  <audio controls controlsList='nodownload' style='display: block; margin-top: 10px'><source src='audio/tone-waveform.wav' type='audio/mpeg'></audio>
...
![**A sine wave with a frequency of 120 Hz.** (ref:cf23f580-6c64-4a5c-a2fd-2a384ddf36ec) ](images/sine-wave-frequency=120.png){width='500'}

(ref:cf23f580-6c64-4a5c-a2fd-2a384ddf36ec)  <audio controls controlsList='nodownload' style='display: block; margin-top: 10px'><source src='audio/tone-frequency=120.wav' type='audio/mpeg'></audio>

If we double the frequency, it sounds an octave higher:

![**A sine wave with a frequency of 240 Hz.** (ref:dfd30e9d-d3f4-49da-b816-7490d1294ce8) ](images/sine-wave-frequency=240.png){width='500'}

(ref:dfd30e9d-d3f4-49da-b816-7490d1294ce8)  <audio controls controlsList='nodownload' style='display: block; margin-top: 10px'><source src='audio/tone-frequency=240.wav' type='audio/mpeg'></audio>

If we multiply the frequency by another 1.5, it sounds an additional perfect fifth higher:

![**A sine wave with a frequency of 360 Hz.** (ref:ef7f1a05-abc7-429b-8068-161ed528c104) ](images/sine-wave-frequency=360.png){width='500'}

(ref:ef7f1a05-abc7-429b-8068-161ed528c104)  <audio controls controlsList='nodownload' style='display: block; margin-top: 10px'><source src='audio/tone-frequency=360.wav' type='audio/mpeg'></audio>
...
![(ref:845d2110-40c6-4dca-ba80-37cdec234f12)  **Wavelength of a travelling wave.** Credit: Tom Walsh, [oPhysics](https://ophysics.com/w6.html), free for non-profit educational purposes.](images/1x1.png)

(ref:845d2110-40c6-4dca-ba80-37cdec234f12) <video autoplay muted loop width=800px> <source src='images/wavelength.mov' type='video/mp4'> </video>
...
![**Sawtooth wave.** (ref:43153ee7-7543-4b4a-87a1-a070926c8712) ](images/sawtooth-wave.png){width='400px'}

(ref:43153ee7-7543-4b4a-87a1-a070926c8712)  <audio controls controlsList='nodownload' style='display: block; margin-top: 10px'><source src='audio/sawtooth-wave.wav' type='audio/mpeg'></audio>

Here's a square wave, which has rectangular corners:

![**Square wave.** (ref:3d0e59e5-a970-4a31-8b36-bbad8db28234) ](images/square-wave.png){width='400px'}

(ref:3d0e59e5-a970-4a31-8b36-bbad8db28234)  <audio controls controlsList='nodownload' style='display: block; margin-top: 10px'><source src='audio/square-wave.wav' type='audio/mpeg'></audio>
...
![**Idealised harmonic spectrum.** The sound example begins by playing the full tone, then demonstrates how the tone can be built up by superimposing pure tones one by one. (ref:a713a2af-bfb6-44da-bd2c-2e25ccd13086) ](images/harmonic-spectrum.png){width='100%'}

(ref:a713a2af-bfb6-44da-bd2c-2e25ccd13086)  <audio controls controlsList='nodownload' style='display: block; margin-top: 10px'><source src='audio/harmonic-spectrum.wav' type='audio/mpeg'></audio>
...
![**Spectrogram computed from a recording of a violin.** Credit: megatron, [CC BY-SA 3.0](https://creativecommons.org/licenses/by-sa/3.0/deed.en) (ref:2418f3d1-4e4b-4a8c-9d11-64f4c8b0adae) ](images/spectrogram.png){width='100%'}

(ref:2418f3d1-4e4b-4a8c-9d11-64f4c8b0adae)  <audio controls controlsList='nodownload' style='display: block; margin-top: 10px'><source src='audio/spectrogram-violin.mp3' type='audio/mpeg'></audio>
...
![(ref:50f67cfc-026f-4b3e-aa45-978a53dbe18d)  **Dialup modem handshake sound (spectrogram).** Scotty H, via YouTube](images/1x1.png)

(ref:50f67cfc-026f-4b3e-aa45-978a53dbe18d) <iframe width="560" height="315" src="https://www.youtube.com/embed/vvr9AMWEU-c?start=0" style="display: block; margin-bottom: 25px" title="Dialup modem handshake sound (spectrogram)." frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
