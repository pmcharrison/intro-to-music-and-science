...
![**A sine wave with an amplitude of 0.5.** (ref:fadc613b-9f03-4337-9f80-a3d32164e402) ](images/sine-wave-amplitude=0.5.png){width='500'}

(ref:fadc613b-9f03-4337-9f80-a3d32164e402)  <audio controls controlsList='nodownload' style='display: block; margin-top: 10px'><source src='audio/tone-waveform.wav' type='audio/mpeg'></audio>
...
![**A sine wave with a frequency of 120 Hz.** (ref:a0a1ff45-9018-43bc-bf37-1e79438921a9) ](images/sine-wave-frequency=120.png){width='500'}

(ref:a0a1ff45-9018-43bc-bf37-1e79438921a9)  <audio controls controlsList='nodownload' style='display: block; margin-top: 10px'><source src='audio/tone-frequency=120.wav' type='audio/mpeg'></audio>

If we double the frequency, it sounds an octave higher:

![**A sine wave with a frequency of 240 Hz.** (ref:bb6b0a31-1cf7-4d15-a8e0-ed845c0317fb) ](images/sine-wave-frequency=240.png){width='500'}

(ref:bb6b0a31-1cf7-4d15-a8e0-ed845c0317fb)  <audio controls controlsList='nodownload' style='display: block; margin-top: 10px'><source src='audio/tone-frequency=240.wav' type='audio/mpeg'></audio>

If we multiply the frequency by another 1.5, it sounds an additional perfect fifth higher:

![**A sine wave with a frequency of 360 Hz.** (ref:e7f7c1d6-7d09-4c68-ab0e-6aaa9151b375) ](images/sine-wave-frequency=360.png){width='500'}

(ref:e7f7c1d6-7d09-4c68-ab0e-6aaa9151b375)  <audio controls controlsList='nodownload' style='display: block; margin-top: 10px'><source src='audio/tone-frequency=360.wav' type='audio/mpeg'></audio>
...
![(ref:54e17842-15f8-41c1-b65c-a406613c486d)  **Wavelength of a travelling wave.** Credit: Tom Walsh, [oPhysics](https://ophysics.com/w6.html), free for non-profit educational purposes.](images/1x1.png)

(ref:54e17842-15f8-41c1-b65c-a406613c486d) <video autoplay muted loop width=800px> <source src='images/wavelength.mov' type='video/mp4'> </video>
...
![**Sawtooth wave.** (ref:974d7251-dbec-4fcb-9a04-77f0a9d76485) ](images/sawtooth-wave.png){width='400px'}

(ref:974d7251-dbec-4fcb-9a04-77f0a9d76485)  <audio controls controlsList='nodownload' style='display: block; margin-top: 10px'><source src='audio/sawtooth-wave.wav' type='audio/mpeg'></audio>

Here's a square wave, which has rectangular corners:

![**Square wave.** (ref:3d4989de-8a24-4e7f-ad97-ff834746d031) ](images/square-wave.png){width='400px'}

(ref:3d4989de-8a24-4e7f-ad97-ff834746d031)  <audio controls controlsList='nodownload' style='display: block; margin-top: 10px'><source src='audio/square-wave.wav' type='audio/mpeg'></audio>
...
![**Idealised harmonic spectrum.** The sound example begins by playing the full tone, then demonstrates how the tone can be built up by superimposing pure tones one by one. (ref:4fee52bb-b99f-47f5-9d50-909e18593b67) ](images/harmonic-spectrum.png){width='100%'}

(ref:4fee52bb-b99f-47f5-9d50-909e18593b67)  <audio controls controlsList='nodownload' style='display: block; margin-top: 10px'><source src='audio/harmonic-spectrum.wav' type='audio/mpeg'></audio>
...
![**Spectrogram computed from a recording of a violin.** Credit: megatron, [CC BY-SA 3.0](https://creativecommons.org/licenses/by-sa/3.0/deed.en) (ref:4f05f220-670c-4ef7-99a8-c34da43c62d0) ](images/spectrogram.png){width='100%'}

(ref:4f05f220-670c-4ef7-99a8-c34da43c62d0)  <audio controls controlsList='nodownload' style='display: block; margin-top: 10px'><source src='audio/spectrogram-violin.mp3' type='audio/mpeg'></audio>
...
![(ref:e43afd86-fa78-4ba3-9df2-a2b911b77308)  **Dialup modem handshake sound (spectrogram).** Scotty H, via YouTube](images/1x1.png)

(ref:e43afd86-fa78-4ba3-9df2-a2b911b77308) <iframe width="560" height="315" src="https://www.youtube.com/embed/vvr9AMWEU-c?start=0" style="display: block; margin-bottom: 25px" title="Dialup modem handshake sound (spectrogram)." frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
