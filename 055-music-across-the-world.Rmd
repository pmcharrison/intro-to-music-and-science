...
Comparative musicology saw initial popularity from the late 1800s, with researchers such as Erich von Hornbostel (1877-1935). Relevant studies included investigations of scale systems and instrument usage across the world. Unfortunately, this early work ended up manifesting certain problematic characteristics, for example an 'evolutionist' way of thinking that considered Western art music to be the ultimate end-goal of musical style development, and that considered other musical styles to be 'primitive' in various ways. These philosophical and interpretative issues are part of the reason why ethnomusicology approaches largely displaced comparative musicology for most of the 20th century.
...
```{r}
knitr::include_url("https://www.themusiclab.org/nhs_explorer/ethnography/index.html", height = "700px")
```
...
```{r}
knitr::include_url("https://www.themusiclab.org/nhs_explorer/discography/index.html", height = "700px")
```
