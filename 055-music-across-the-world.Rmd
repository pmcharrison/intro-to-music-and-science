...
```{r}
embed_youtube_video("8_UnANdDqJc", width = "100%", title = "Yodelling.", info = "'Auf und auf voll lebenslust', sung by Franzl Lang.")
```
...
![Dissonance model for the bonang, excerpted from @Sethares2005-ko.](images/sethares-bonang-model.png){width="100%"}
...
![Dissonance model for the saron, excerpted from @Sethares2005-ko.](images/sethares-saron-model.png){width="100%"}
