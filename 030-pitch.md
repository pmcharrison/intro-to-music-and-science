...
![**An example sine wave.** (ref:2364ebba-5dd3-49ec-a7a5-113c7b24cd49) ](images/sine-wave-frequency=240.png){width='400px'}

(ref:2364ebba-5dd3-49ec-a7a5-113c7b24cd49)  <audio controls controlsList='nodownload' style='display: block; margin-top: 10px'><source src='audio/tone-frequency=240.wav' type='audio/mpeg'></audio>
...
**The mechanics of resonance**. It took a while for scientists to work out how exactly the ear might resonate in response to pitches. Two theories were particularly prominent, historically speaking: Helmholtz's *sympathetic resonance* theory [@Helmholtz1875-fm], and von Békésy's *travelling wave* theory [@Von_Bekesy1960-oh]. According to Helmholtz's theory, the ear contains many separate resonant elements, each tuned to a distinct characteristic frequency, similar to the strings in a piano. Incoming sound would then cause particular elements to resonate according to the sound's spectral frequencies (Panel A in the figure below). According to von Békésy, sound vibrations instead induce a wave to travel down the length of the basilar membrane, analogous to what happens when you hold a rope at one end and flick it (Panel B; see also [this link](https://isle.hanover.edu/Ch10AuditorySystem/Ch10TravellingWave.html) for an interactive demo). Given appropriate mechanical construction, such a travelling wave should end up stimulating different parts of the membrane according to the different spectral frequencies. von Békésy's theory is now considered validated by an set of painstaking dissection experiments that won him the 1961 Nobel Prize in Physiology or Medicine, but some people do still think Helmholtz's original theory has some mileage; see @Bell2004-wo for more history and discussion.
