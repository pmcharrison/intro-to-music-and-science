...
Many cognitive scientists regularly write computer programs as part of their research. There are several good motivations for this:
...
**Addressing woolliness.** When we write about psychological theories with words, it's easy for ambiguities to slip in, making our arguments 'woolly'. In contrast, if we implement our theory as a computer model, we are forced to be completely explicit about what we mean. In the process, we may uncover important unwritten assumptions or logical gaps in our theory that deserve addressing.

**Enhancing testability.** A good scientific theory should be good at predicting observed phenomena. In order to test this, we must generate predictions from the theory in various empirical contexts.

**Supporting objective evaluation.**
...
-   A tool for getting one's thoughts on paper

-   A tool for spotting hidden assumptions or logical gaps

-   A tool for communication

-   A tool for empiricism (testable predictions)
